# take a .bmp image, perform operation in numpy, produce .dat file for comparing with testbench output
...
output[...,:-1] = np.diff(img)

with open("../bssr_64_sim_h.dat", "w") as fd:
    for row in output:
        for col in row:
